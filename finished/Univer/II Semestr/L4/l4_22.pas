                             ...
                             begin
                                  If (ToFind = cat[i].author) then
                                     begin
                                          ClrScr;
                                          GotoXY(30,5);
                                          WriteLn('Автор: ',author);GotoXY(30,6);
                                          WriteLn('Название ',name);GotoXY(30,7);
                                          WriteLn('Колличество ',numpr);GotoXY(30,8);
                                          WriteLn('Щифр ',shifr);GotoXY(26,10);
                                          keypr:=Readkey;
                                          ClrScr;
                                     end;
                             end;
                      Inc(i);
                    until (keypr=#13)or(i=lastnum);
        end;
   end
 end;
